...
class CheckerSuite(unittest.TestCase):
    ...
    # def test60(self):
    #     input = """ main : function integer (a : integer, b : float) {} x : integer = main(1.4 , 1) ;"""
    #     expect = "Type mismatch in expression: FloatLit(1.4)"
    ...
    # # def test62(self):
    # #     input = """ main : function integer (a : integer, b : float) {} main1 : function integer (c : integer, a : float) inherit main {} """
    ...
    def test71(self):
        input = """ a, b, c : integer ; main : function integer (a : integer, b : float) 
        {
            c : integer ;
            d : integer ;   
        } """
